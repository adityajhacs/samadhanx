    ...
    async function loadCollaboration() {
      try {
        ...
        const apiCollaboration =
          await apiRequest<ApiCollaboration>(
        ...
        if (apiCollaboration.project_id) {
          try {
            project = await apiRequest<ApiProject>(
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-100 px-6">
        <div className="max-w-lg rounded-2xl border border-rose-200 bg-white p-8 text-center shadow-sm">
          ...
          <Link
            ...
            className="mt-6 inline-flex rounded-xl bg-teal-700 px-5 py-3 text-sm font-semibold text-white transition hover:bg-teal-800"
          >
      ...
      <section className="border-b border-teal-900 bg-gradient-to-br from-teal-950 via-teal-900 to-emerald-950">
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <div className="max-w-3xl">
            ...
            {/* Project Name */}
            <p className="mb-3 text-sm font-semibold text-teal-200">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="rounded-3xl border border-emerald-200 bg-white p-8 text-center shadow-sm sm:p-12">
              ...
              <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-slate-500">
                Your message has been prepared for the project team.
                Actual message delivery will be connected once the
                collaboration messaging API is available.
              </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-5 text-slate-500">
                      Share your requirements or questions with the
                      project team.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs leading-5 text-teal-800/70">
                        This contact form is currently a frontend-only
                        interface. The collaboration and project
                        information shown on this page is loaded from
