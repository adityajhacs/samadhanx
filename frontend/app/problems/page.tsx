    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-6 pt-6">
        <div className="max-w-5xl">
          ...
          <h2 className="text-4xl font-bold tracking-tight md:text-5xl">
            ...
            Discover challenges reported by communities and find opportunities to create meaningful solutions together.
            </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
            ...
            >
              ...
              <div className="mt-auto flex items-center justify-between pt-6">
                <span className="text-sm font-medium text-slate-500">
                  {problem.count} reported challenges
                </span>
        ...
        >
          <div className="mx-auto max-w-6xl">
            <div className="mb-8">
              <p className="font-semibold text-teal-600">REPORT A PROBLEM</p>
              ...
              <p className="mt-3 text-slate-600">
                Share a real-world problem and help us connect it with people who can
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <select required className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-100">
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="button"
                  className="rounded-xl border border-teal-200 px-4 py-3 text-sm font-semibold text-teal-600 hover:bg-teal-50"
                >
                  <MapPin size={17} /> Use Location
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-center transition hover:border-teal-300 hover:bg-teal-50">
                <span className="text-2xl"><Camera size={18} /></span>
            ...
            <div>
              ...
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 px-4 py-3 text-center transition hover:border-teal-300 hover:bg-teal-50">
                <span className="text-2xl"><Video size={18} /></span>
                <span className="mt-2 text-sm font-semibold text-slate-700">
                  Upload Video  
                </span>
                <span className="mt-1 text-xs text-slate-500">
            ...
            <div className="mt-6">
              ...
              <select className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-100">
            ...
            <button
              type="submit"
              className="mt-8 rounded-xl bg-teal-600 px-6 py-3 font-semibold text-white shadow-sm hover:bg-teal-700"
            >
              Submit Problem
            </button>
      ...
      <section className="mx-6 mb-16 rounded-[2rem] bg-teal-600 px-8 py-14 text-white md:px-16">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <div>
            <p className="font-semibold text-teal-200">HAVE A PROBLEM?</p>
            ...
            <p className="mt-4 max-w-2xl text-teal-100">
              Share a real-world problem and help innovators discover opportunities to make an impact.
            </p>
          </div>
